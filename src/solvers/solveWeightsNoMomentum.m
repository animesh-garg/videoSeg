function [newW] = solveWeightsNoMomentum(X, W, video, T, lambda, d)
%SOLVE_WEIGHT_QUAD_MOMENTUM Solve for the flow weights given a pixel labeling (using
% cplex) without any momentum constraint
